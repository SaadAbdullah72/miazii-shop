...
export const getWelcomeTemplate = (name) => {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #ebebeb; border-radius: 20px; overflow: hidden; background-color: #ffffff;">
        <div style="background-color: #fed700; padding: 40px 20px; text-align: center;">
            <img src="https://miazi-shop.vercel.app/logo.png" alt="Miazi Shop" style="width: 120px; margin-bottom: 20px;">
        ...
        <div style="padding: 40px 30px; color: #333e48; line-height: 1.6;">
            ...
            <p style="font-size: 16px; margin-top: 20px;">We're absolutely thrilled to have you at <strong>Miazi Shop</strong> – your new home for premium electronics and high-performance tech.</p>
            ...
            <div style="background-color: #f5f5f5; border-radius: 15px; padding: 25px; margin: 30px 0; text-align: center;">
                ...
                <a href="https://miazi-shop.vercel.app" style="display: inline-block; margin-top: 15px; background-color: #fed700; color: #333e48; text-decoration: none; padding: 15px 35px; border-radius: 50px; font-weight: bold; font-size: 16px; transition: all 0.3s ease;">SHOP THE COLLECTION</a>
            </div>
        ...
        <div style="background-color: #333e48; color: #ffffff; padding: 30px 20px; text-align: center; font-size: 12px; letter-spacing: 1px;">
            <p style="margin: 0;">&copy; 2026 MIAZI SHOP | All Rights Reserved</p>
